...
const Svg = ({id}) => {
  ...
  const entities = {
    ...
    ladder: (
      <svg className="ladder" version="1.1" x="0" y="0" viewBox="0 0 604 706">
        <path
          d="M484.8,598l6.3,2h36.5v25.2c-34.6,18.1-28.6,80.8,21,80.8c48.4,0,55.4-59.7,23.5-79.4V576v-21V451.2V377v-75.9
        v-74.3V151v-25V79.4C603.9,59.7,597,0,548.6,0c-49.6,0-55.7,62.7-21,80.8V106h-36.5l-6.3,2H128.1l-6.3-2H85.4V80.8
        C120.1,62.7,114,0,64.4,0C16,0,9,59.7,40.9,79.4V126v25v75.8v74.3V377v74.3V555v21v50.5C9,646.3,16,706,64.4,706
        c49.6,0,55.7-62.7,21-80.8V600h36.5l6.3-2H484.8z M129.4,123h354.2c0,0,4.3,1.9,4.3,5.5s-4,5.5-4,5.5H129.1c0,0-4-1.9-4-5.5
        S129.4,123,129.4,123z M129.4,583c0,0-4.3-1.9-4.3-5.5s4-5.5,4-5.5h354.7c0,0,4,1.9,4,5.5s-4.3,5.5-4.3,5.5H129.4z M128.4,557.3
        l-9.3-2.3H85.4V451.2h33.7l9.3-2.3h356.2l9.3,2.3h33.7V555h-33.7l-9.3,2.3H128.4z M129.1,434.2c0,0-4-1.9-4-5.5s4.3-5.5,4.3-5.5
        h354.2c0,0,4.3,1.9,4.3,5.5s-4,5.5-4,5.5H129.1z M128.1,408.2l-6.3-2H85.4V301.1h33.7l9.3-2.3h356.2l9.3,2.3h33.7v105.1h-36.5
        l-6.3,2H128.1z M125.1,278.6c0-3.6,4.3-5.5,4.3-5.5h354.2c0,0,4.3,1.9,4.3,5.5s-4,5.5-4,5.5H129.1
        C129.1,284.1,125.1,282.2,125.1,278.6z M527.5,256.1h-36.5l-6.3,2H128.1l-6.3-2H85.4V151h33.7l9.3-2.3h356.2l9.3,2.3h33.7V256.1z"
        />
      </svg>
    ),
    fType: (
      <svg className="fType" version="1.1" x="0" y="0" viewBox="0 0 604 706">
        <path
    ...
    vk: (
      <svg className="vkontakte" viewBox="0 0 30 30">
    ...
    fb: (
      <svg className="facebook" viewBox="0 0 512 512">
    ...
    instagram: (
      <svg className="instagram" viewBox="0 0 420 419.997">
        <path
    ...
    tint: (
      <svg className="tint" viewBox="0 0 352 512">
    ...
    bolt: (
      <svg className="bolt" viewBox="0 0 320 512">
